...
if(empty($errors)){
    ...
    // dd($_POST);
    $db->query("INSERT INTO users(name,email,password,phone,address,profile,is_admin,created_at,updated_at) VALUES
                      (:name,:email,:password,:phone,:address,:profile,:is_admin,:created_at,:updated_at)",[
        'name' => $_POST['name'],
        'email'=>$_POST['email'],
