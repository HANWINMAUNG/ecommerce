...
<div class="text-right mb-4"><a href="/admin/shop_slider" class="btn btn-dark round">Back</a></div>
...
<div class="col-12 col-md-12 ">
        <div class="card">
            ...
            <?php endif; ?>
                ...
                <form class="form form-vertical" method="POST" action="/admin/shop_slider" enctype="multipart/form-data">
                <div class="form-body">
                    <div class="row">
