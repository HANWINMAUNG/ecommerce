...
<div class="text-right">
       <a href="/admin/product" class="btn btn-dark round mb-5">Back</a>
</div>
...
<div class="card">
                    <div class="card-content text-center">
                        <div class="card-body">
                        <form method="POST" action="/admin/product/destroy">
                      ...
                      <input type="hidden" name="id" value="<?=$product['id']?>">
                       ...
                       <p class="card-text">Are you sure to delete<span class="text-primary"><?=$product['name']?></span>?</p>
                            ...
                            <a href="/admin/product" class="btn btn-secondary btn-sm">Cancel</a>
                      </form>
                            </div>
                        </div>
                    </div>
