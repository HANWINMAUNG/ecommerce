...
<div class="text-right mb-4"><a href="/admin/category" class="btn btn-dark round">Back</a></div>
...
<div class="col-12 col-md-12 ">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form form-vertical"   method="POST" action="/admin/category" enctype="multipart/form-data">
                <div class="form-body">
                    <div class="row">
