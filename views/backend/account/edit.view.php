...
<div class="col-12 col-md-12 ">
        <div class="card">
            ...
            <form class="form form-vertical"   method="POST" action="/admin/accounts" enctype="multipart/form-data">
                ...
                <div class="form-body">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                         <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text"  name="name" class="form-control" placeholder="Name" id="name-id-icon" value="<?=$user['name']?>">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text"  name="email" class="form-control" placeholder="Email" id="email-id-icon" value="<?=$user['email']?>">
                                <div class="form-control-icon">
                    ...
                    <div class="col-12">
                        <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="text" name="phone" class="form-control" placeholder="Mobile" id="mobile-id-icon" value="<?=$user['phone']?>">
                                <div class="form-control-icon">
                    ...
                    <div class="form-group has-icon-left">
                            ...
                            <div class="position-relative">
                                <input type="file" name="profile_name" class="form-control" placeholder="Input with icon left" id="first-name-icon"value="<?=$user['profile']?>">
